...
const Projects = () => {
  ...
  return (
    <div id="projetos" className="w-full h-auto flex flex-col items-center bg-indigo-700 px-0 py-7 md:p-10 sm:mt-90 md:mt-5 lg:mt-0">
      <h1 className='text-5xl md:text-7xl lg:text-8xl font-bold pb-10 text-white text-shadow-violet-500'>Projetos</h1>
      <div 
      className="
