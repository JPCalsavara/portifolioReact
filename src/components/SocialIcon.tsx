...
const pathImagesDefault = "../../public/images/social/"; // Ajustado para um caminho relativo ao servidor
...
export const SocialIcon = () => {
    ...
    return (
        <div className='flex justify-around items-center gap-3 flex-wrap py-2 '>
            ...
            href="../../public/files/curriculo.pdf" download="Curriculo_Joao_Calsavara.pdf">Clique para CV</a>
        </div>
    );
};