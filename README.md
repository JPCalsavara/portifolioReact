...
npm (geralmente vem com o Node.js) ou yarn (opcional) - Instalar Yarn
Instalação ⚙️
...
Abra http://localhost:5173 (ou a porta indicada no terminal) para visualizar no navegador.
...
Este é um modelo básico. Sinta-se à vontade para adicionar, remover ou modificar seções conforme a necessidade específica do seu projeto! Boa sorte!
